...

{
    ...
    public Guid SupervisorId { get; set; }          // кто руководитель

    public int? IdScheduledPractice { get; set; }   // практика из расписания (необязательно)

    public int? IdSpecialization { get; set; }      // специализация (если не из расписания)

    [Required]

    public int IdDepartment { get; set; }           // подразделение

    [Required]

    public int IdAddress { get; set; }              // адрес
